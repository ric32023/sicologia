...
?>
        ...
        <form role="form" name="frm_cargo" method="post" action="">
        	<script>
            	function fguardar(){
					if(document.getElementById('txtcuestionario').value==""){
						alert('Digite el Cuestionario');
						return false;	
					}
					$('#divmsn').html("<i class='fa fa-refresh fa-spin fa-3x stat-elem'></i>Procesando..");
					var datos = "accion=1&txtcuestionario="+document.getElementById('txtcuestionario').value+"&txtdescripcion="+document.getElementById('txtdescripcion').value;
					$('#div_contenido_cargo').load("administrador/frm_cuestionario_detalle.php",datos);
				}
				function fmostrarconsulta(){
					var datos = "accion=2";
					$('#msn_consultacargo').load('consultas/frm_consulta_cuestionario.php',datos)
				}
				...
				function fmostrartabla(){
					var datos = "accion=2";
					$('#div_mostrar_tabla').load('consultas/frm_consulta_cuestionario.php',datos)
				}
...
<div class="col-md-6">
	<div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="frm_cuestionario" name="frm_cuestionario" method="post" action="">
              <div class="box-body">
              	<div class="row">
                 	<div class="col-md-4">    
                		<label>Cuestionario</label>
                		<input type="text" class="form-control" id="txtcuestionario" placeholder="Digite el Nombre del cuestionario" />
                    </div>
                    <div class="col-md-8">    
                		<label>Descripcion</label>
                		<input type="text" class="form-control" id="txtdescripcion" placeholder="Digite la descripcion del cuestionario"  />
                    </div> 
 ...
 <div class="box-footer">
            	<table width="100%">
                	<tr>
                    	<td>
                        	<button type="button" onclick="llamar_cuestionario()" class="btn btn-default">Nuevo</button>
