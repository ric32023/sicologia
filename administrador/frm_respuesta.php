...
<div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" name="frm_respuesta" id="frm_respuesta" method="post" action="">
            <script>
            	function fguardar(){
					if(document.getElementById('txtrespuesta').value==""){
						alert('Digite las Respuesta');
						return false;	
					}
					$('#divmsn').html("<i class='fa fa-refresh fa-spin fa-3x stat-elem'></i>Procesando..");
					var datos = "accion=1&txtrespuesta="+document.getElementById('txtrespuesta').value;
					$('#div_contenido_cargo').load("administrador/frm_respuesta_detalle.php",datos);
				}
				function fmostrarconsulta(){
					var datos = "accion=2";
					$('#msn_consultacargo').load('consultas/frm_consulta_respuesta.php',datos)
				}
				...
				function fmostrartabla(){
					var datos = "accion=2";
					$('#div_mostrar_tabla').load('consultas/frm_consulta_respuesta.php',datos)
				}
				
            </script>
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Digite Respuesta</label>
                  <input type="text" class="form-control" id="txtrespuesta" placeholder="Digite la Respuesta">
                </div>
              ...
              <!-- /.box-body -->
               ...
               <div class="box-footer">
            	<table width="100%">
                	<tr>
                    	<td>
                        	<button type="button" onclick="llamar_respuesta()" class="btn btn-default">Nuevo</button>
