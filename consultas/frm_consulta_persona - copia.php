...
<div class="box">
            ...
            <div class="box-body">
             <table id="example1" class="table table-bordered table-striped">
								...
								per_fechanacimiento,per_estado FROM persona");
                                while($cocargo=mysql_fetch_array($consulcargo)){
                                    ...
                                    echo"
                                    <tr>
                                        <td>$cocargo[per_documento]</td>
                                        <td>$cocargo[per_primernombre]</td>
										<td>$cocargo[per_segundonombre]</td>
										<td>$cocargo[per_primerapellido]</td>
										<td>$cocargo[per_segundoapellido]</td>
										<td>$cocargo[per_fechanacimiento]</td>
										<td>$cocargo[per_direccion]</td>
										<td>$cocargo[per_telefono]</td>
										<td>$cocargo[per_email]</td>
                                        <td>".$estado."</td>
                                        <td>";
											if($cocargo['per_estado']=='A'){
											echo"
											...
											echo"
												<button type='button' onclick='frecuperar($cocargo[per_cod])'><i class='fa fa-check-circle'></i> </button>
												";	
											}
									echo"		
										</td>
