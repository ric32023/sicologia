...
<!--[if lt IE 9]> 
    ...
    <![endif]-->
<title>MentalPar - Single page website</title>
...
<div class="navbar-brand scroll-top logo  animated bounceInLeft"> 
...
<!--/.header-->
<section id="team" class="page-section"><!--/.container--> 
</section>
    ...
    <div class="container">
      <div class="row">
        <div class="heading text-center"> 
          <!-- Heading -->
          <h2>Bienvenido</h2>
          <p>Esta seccion es para autenticar al usuario que va ingresar al sistema.</p>
        </div>
      </div>
		...
		<form name="frmusuario" id="frmusuario"  method="post"  action="usuario_detalle.php"> 
		...
		<div align="center"><button type="submit" name="btnenviar" id="btnenviar" class="btn btn-primary ">Enviar</button>
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
		...
		<p><br />
                ...
                <div class="col-sm-12 col-md-4">
                    <h4>Nota:</h4>
                    <address>
                        Digite su numero de documento y luego presiona el boton enviar para empezar a llenar los formularios para el cargo especifico<br>
                    </address>
                    <h4>Cualquier Duda:</h4>
                    <address>
                        320 8121 839 - 315 926 7048<br>
                    </address>
                </div>
            </div>
    </div>
